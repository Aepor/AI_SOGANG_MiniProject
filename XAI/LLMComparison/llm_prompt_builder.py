"""Build LLM prompts for sentiment-evidence collection."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    """Parse CLI arguments."""
    parser = argparse.ArgumentParser(description="Build LLM prompt JSONL from selected reviews.")
    parser.add_argument(
        "--selected-reviews",
        type=Path,
    ...
    parser.add_argument("--output", type=Path, default=comparison_dir() / "llm_prompts.jsonl")
